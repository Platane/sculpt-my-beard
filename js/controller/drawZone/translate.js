...
var mouseMove = function( event ){
    ...
    this.model.camera.origin.x = this._origin.x + ( this._anchor.x - event.screenX ) / this.model.camera._zoom
    this.model.camera.origin.y = this._origin.y + ( this._anchor.y - event.screenY ) / this.model.camera._zoom
